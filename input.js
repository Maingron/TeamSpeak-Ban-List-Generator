var letters = {
	...
	"b": [0b1, "b", "B", "6", "₿", "ß", "฿", "ᗷ", "ᗽ", "ᛒ", "Ь", "ᖯ", "ᑲ", "Ꮟ"],
	"c": [0b1, "c", "C", "(", "©", "Ç", "©", "¢", "￠", "₡", "ᴄ", "ϲ", "ｃ", "𝖼", "ⅽ", "ⲥ", "ꮯ", "𐐽"],
	"d": [0b1, "d", "D", "Ð", "𐐀", "₫", "ɗ", "ԁ", "ᗞ", "ᗟ", "ᗠ", "ᗤ", "ᗪ", "ᴅ", "Ꮷ", "ᑯ", "ⅾ", "ꓒ"],
	"e": [0b1, "e", "E", "3", "³", "€", "È", "É", "Ê", "Ë", "£", "￡", "ę", "ε", "₤", "℮"],
	"f": [0b1, "f", "F", "ꬵ"],
	"g": [0b1, "g", "G", "ɡ"],
	"h": [0b1, "h", "H", "ㅐ", "ᕼ", "ᚺ", "հ", "Ꮒ", "ℎ", "𝚑"],
	"i": [0b0, "i", "I", "l", "!", "1", "|", "Ì", "Í", "Î", "Ï", "Ĩ", "ĩ", "Ī", "ī", "Ĭ", "ĭ", "Į", "į", "İ", "ı", "ㅣ", "¡", "¦", "ӏ", "ᛌ", "ᥣ", "ɪ", "ℹ", "ⅰ", "ꭵ", "Ι", "׀", "ߊ", "ⅼ", "∣"],
	"j": [0b1, "j", "J", "Į", "į", "Ĵ", "ĵ", "ϳ", "ј"],
	"k": [0b1, "k", "K", "Ķ", "ķ", "ĸ", "𝑘"],
	"l": [0b1, "l", "L", "i", "I", "!", "1", "|", "Ì", "Í", "Î", "Ï", "Ĩ", "ĩ", "Ī", "ī", "Ĭ", "ĭ", "Į", "į", "İ", "ı", "Ĺ", "Ļ", "Ł", "ł", "ĺ", "ļ", "Ɩ", "ǀ", "Ι", "ו"],
	"m": [0b1, "m", "M", "ՠ", "ա", "൩", "൱", "ᗰ", "ต", "ถ", "₥", "₼", "ⅿ", "ᴍ"],
	"n": [0b1, "n", "N", "Ń", "ń", "Ņ", "ņ", "Ň", "ก", "ด", "ท", "ň", "ŉ", "Ŋ", "h", "ŋ", "ղ", "ո", "൨", "ภ", "∩", "₦", "ɴ", "ռ"],
	"o": [0b1, "o", "O", "ö", "0", "°", "Ō", "ō", "Ŏ", "ŏ", "Ő", "ő", "θ", "օ", "ഠ", "൦", "ㅇ", "σ", "᥆", "᭜", "᱀", "ᱛ", "ο", "ס", "०", "੦", "૦", "௦", "೦", "๐", "໐", "ဝ", "၀", "ჿ", "ᴏ", "𐐬", "𐓪"],
	"p": [0b1, "p", "P", "₱"],
	"q": [0b1, "q", "Q", "θ"],
	...
	"ö": [0b1, "ö"],
	"ü": [0b1, "ü"],
	"1": [0b0, "1", "i", "I", "!", "|", "Ì", "Í", "Î", "Ï", "Ĩ", "ĩ", "Ī", "ī", "Ĭ", "ĭ", "Į", "į", "İ", "ı", "₁", "ⅼ"],
	"2": [0b0, "2", "²", "₂", "ᒾ", "ᒿ"],
	"3": [0b0, "3", "³", "₃"],
	"4": [0b0, "4", "A", "₄"],
	"5": [0b0, "5", "S", "₅"],
